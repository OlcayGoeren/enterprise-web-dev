...
const ShareModal: React.FunctionComponent<IShareModalProps> = (props) => {
    ...
    return (
        <div className=" bg-[#DBDBDB] flex flex-col justify-between absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90%] rounded-lg sm:w-[50%]">
            ...
            <button onClick={() => copyme()} className='flex bg-[#C4C4C4] p-4 w-[90%] justify-center rounded-lg ml-3 m-10 flex-wrap'>
                <div className="mr-5 text-gray-500 ">
                    {process.env.REACT_APP_FRONTEND_URL + "/share/\n" + shareId}
                </div>
